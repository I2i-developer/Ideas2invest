...
export default function ReportExport({ results, reportRef, userInfo, isLoggedIn }) {
  ...
  const exportPDF = async () => {
    ...
    // ✅ Insert Charts (from on-page DOM — ensure charts exist)
    pdf.addPage();
    ...
    <div className={styles.card}>
      ...
      <div className={styles.exportWrapper}>
        <button
          ...
          onClick={exportPDF}
          disabled={!isLoggedIn} // 👈 disables if not logged in
        ...
        {!isLoggedIn && (
          <p style={{ color: "#d00", marginTop: "8px", fontSize: "0.9rem" }}>
            🔒 Please log in to download your personalized report.
          </p>
        )}
      </div>
    </div>
...
//         <h2>Ideas2Invest — Comprehensive Report</h2>
