    ...
    <div className={styles.card}>
      ...
      <div className={styles.summaryGrid}>
        <div className={styles.summaryItem}>
          <div className={styles.k}>₹ {results.totals.totalFuture.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</div>
          <div className={styles.label}>Total Future Value</div>
        </div>

        <div className={styles.summaryItem}>
          <div className={styles.k}>₹ {totalSIP.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</div>
          <div className={styles.label}>Total Monthly SIP</div>
        </div>

        <div className={styles.summaryItem}>
          <div className={styles.k}>₹ {totalLumpsum.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</div>
