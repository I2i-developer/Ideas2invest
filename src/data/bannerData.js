export const bannerData = {
  ...
  mutualFunds: {
    ...
    description:
      "We help you grow your wealth with the right mutual fund strategies tailored to your goals, risk appetite, and financial journey.",
  ...
  lifeInsurance: {
    title: "Protect What Matters Most with Life Insurance",
    description:
      "Protect your loved ones’ future with comprehensive life insurance solutions tailored to your needs.",
  ...
  pms: {
    ...
    description:
      "Professional portfolio management to maximize returns and manage risks effectively.",
    bannerImage: "/assets/images/services/pms.jpg",
  },
  aif: {
