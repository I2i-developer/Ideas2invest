const howToInvestData = {
  mutualFunds: {
    title: "Mutual Funds",
    steps: [
      {
        id: 1,
        title: "Open WealthMagic",
        description: "Log in to Ideas2Invest and navigate to the Mutual Fund section.",
      ...
      },
      {
        ...
        description:
          "Browse trending funds, recommendations, or search for the fund that suits your goals.",
        icon: "/assets/images/icons/howtoinvest2.svg",
      },
      {
        id: 3,
        title: "Make Your Investment",
        description: "Choose between SIP or one-time investment and start investing easily.",
      ...
      },
      {
        ...
        title: "Track & Grow",
        description:
          "Monitor your investments in the Ideas2Invest dashboard with real-time updates.",
    ...
    steps: [
      {
        ...
        description:
          "Understand your financial obligations, dependents, and goals before choosing coverage.",
        icon: "/assets/images/icons/howtoinvest1.svg",
      },
      {
        id: 2,
        ...
        description:
          "Check claim settlement ratios, premium affordability, and additional riders.",
        icon: "/assets/images/icons/howtoinvest2.svg",
      },
      {
        id: 3,
        ...
        description:
          "Decide between term plans, endowment plans, or ULIPs depending on your priorities.",
        icon: "/assets/images/icons/howtoinvest3.svg",
      },
      {
        id: 4,
        title: "Buy Early",
        description:
          "Purchasing life insurance at a younger age ensures lower premiums and longer coverage.",
        icon: "/assets/images/icons/howtoinvest4.svg",
      },
    ],
  },
